...
if __name__ == '__main__':
    ...
    fname = Path("F:/UMB/VNP46A2.A2016008.h09v05.001.2020258170409.h5")
...
file_path = Path("F:/UMB/VNP46A2.A2016008.h09v05.001.2020258170409.h5")

#print(hashlib.__dict__.keys())

print(hex(913240203))

for algorithm in hashlib.algorithms_available:
    #hashlib.__dict__.get(algorithm)

    try:
        hash = hashlib.__dict__.get(algorithm)()
    except:
        print(f"Algorithm {algorithm} not found.")
        continue

    if "shake" in hash.name:
        continue
    ...
    try:
        print(f"{algorithm} results in {hash.hexdigest()}")
    except:
        pass
exit()
...
with open(file_path, 'rb') as afile:
    ...
    crcvalue = 0
    while len(buffr) > 0:
        crcvalue = zlib.adler32(buffr, crcvalue)
        buffr = afile.read(buffersize)
